                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                             ...
                             <c:if test="${not empty loginerror}">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <a href="/tuntikirjanpito/register" style="float:left; margin-top:10px;"><spring:message code="app.registertext"/></a>
                                    <a href="/tuntikirjanpito/unohdus" style="float:right; margin-top:10px;"><spring:message code="app.forgot"/></a>
