        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            ...
            <div class="panel panel-info" >
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form:form class="form-horizontal" action="/tuntikirjanpito/unohdus" modelAttribute="unohdus" method="post">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <form:input type="text" class="form-control" path="tunnus" placeholder="${username} "/>                                        
                                    </div>
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <form:input type="password" class="form-control" path="salasana" placeholder="${password}" />
                                    </div>
